...
import { PAUTA_INPUT_CLASS } from "../../types/pautas";
import type { MemberPickerProps } from "./type";
    ...
    <div>
      ...
      {members.length === 0 ? (
        <p className="mt-3 rounded-2xl border border-dashed border-zinc-200 px-4 py-5 text-sm text-zinc-500">
          Cadastre companheiros no módulo de membros para vinculá-los às pautas.
        </p>
      ) : (
        <>
          <input
            ...
            className={`${PAUTA_INPUT_CLASS} mt-3`}
